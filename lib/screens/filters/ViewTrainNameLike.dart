...
Future<List<TrainsFetch>> _downloadJSON(String Pattern) async {
  final jsonEndpoint =
  Uri.parse('https://cheliform-ammonia.000webhostapp.com/LikeTrainName.php');

  final response=await http.post(jsonEndpoint,body: {"Pattern":Pattern});
...
class ViewTrainNameLike extends StatelessWidget {
  final String Pattern;
  const ViewTrainNameLike({Key? key, required this.Pattern}) : super(key: key);
